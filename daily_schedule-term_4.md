...
* Thursday, Jan. 12 &mdash; We reviewed *F=ma*, *F=GmM/r*^2, the definition of *g*, and the formula d = 1/2 *at*^2 (some had not had these formulas, but for most it was review, come see me if it wasn't review) &mdash; We calculated the weakened acceleration of gravity 300km above Earth (the International Space Station is actually 408 km above Earth), and we understood why it seems to Chris Hadley that there is no gravity in space &mdash; We discussed free-float frames (pp. 26-28), especially the falling house example on p. 28 &mdash; We discussed the small amount of calculus you will be using in Problem 2-8 and [a way of getting the needed result for &Delta;(1/r^2) without calculus](./resources/ComputingDeltaOneOverRSquared.pdf) &mdash; We need to further discuss approximations (usually the leading non-zero term is sufficient), but today we only scratched the surface on the idea of power series expansions &mdash; We briefly discussed the "egg shape" referred to several times on p. 31 (such a shape is more accurately called an "ovoid," although if you look at the etymology and the lay definition, rather than the mathematician's definition, this just brings you right back to "egg-shaped") &mdash; Finally, I derived the time dilation formula (which gives you a rapid way of solving Problem 1-12)
